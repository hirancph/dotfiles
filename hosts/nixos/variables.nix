{
  ...
  # Stylix theme
  stylixTheme = "catppuccin-blue";
  # Set Stylix Image
  # This will set your color palette
  # Default background
  # Add new images to ~/zaneyos/wallpapers
  #stylixImage = ../../wallpapers/mountainscapedark.jpg;
  #stylixImage = ../../wallpapers/a_blue_and_orange_background.jpg;
  #stylixImage = ../../wallpapers/nixos.png;
  #stylixImage = ../../wallpapers/a_blue_and_grey_logo.png;

  stylixImage = ../../wallpapers/a_black_and_white_logo.png;
  ...
  #animChoice = ../../modules/home/hyprland/aiAnimation.nix;
